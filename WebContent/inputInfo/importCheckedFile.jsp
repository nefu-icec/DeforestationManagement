...
<div id="infomain" class="clearfix">
	...
	<div id="rightBlock">
		<div class="navigation">
			...
			<a href="importCheckedFile.jsp">录入验收文件</a>
			</p>
		</div>
		<div class="content">
			<div class="name">
				...
				<table id="table">
					<tr>
						...
						<th>是否上报数据量</th>
							...
							<%
						ArrayList<CheckList> checkLists=CheckList.getCheckList(CheckList.GET_UNCHECK);
						...
						<td> <a href="uploadCheckedFile.jsp?id=<%=checkLists.get(i).getId()%>">上传验收文件</a>
    <br></td>
					</tr>
						<%
					}
