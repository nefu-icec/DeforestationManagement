	...
	<div id="rightBlock">
		<div class="navigation">
			<p>
				...
				<a href="cutList.jsp">正在添加的采伐计划</a>
			</p>
		</div>
		<div class="content">
			<div class="name">
			...
			<div class="tablecontent">
				<table id="table">
						...
						if(!cutList.isEmpty())
						{
							...
							for(int i=p.getStart();i<p.getEnd();i++)
							{
								...
								<tr <%if(i%2==0) out.print("class='alt'");%>>
									...
									<td><a href="../CutListServlet?task=delete&&lb=<%=checkDatas.get(i).getLb()%>&xb=<%=checkDatas.get(i).getXb()%>">删除</a></td>
								</tr>					
								<%
							}
						}
					...
					%>
					<tr>
						<td><a href="issueCutPlan.jsp">继续添加</a></td>
						<td><a href="../CutListServlet?task=submit">提交</a></td>
						<td><a href="../CutListServlet?task=clear">清空</a></td>
